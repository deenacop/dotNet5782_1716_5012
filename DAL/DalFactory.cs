...
{
    /// <summary>
    /// Static Factory class for creating Dal tier implementation object according to configuration in file config.xml
    /// </summary>
    public static class DalFactory
    {
        ...
        /// of available packages per Dal type.<br/>
        ...
        public static IDal GetDal()
        {
            ...
            catch (KeyNotFoundException ex)
            {
                ...
                throw new DLConfigException($"Wrong Dal type: {dlType}", ex);
            }
